...
export default function TV() {
  ...
  useEffect(() => {
    ...
    const refresh = setInterval(loadPosts, 5000);
  ...
  return (
    <div className="tv-screen">
      ...
      <main className="tv-grid">
        <section className={urgent ? "hero-card urgent-card" : "hero-card"}>
          <div className="label">{urgent ? "הודעה דחופה" : "הודעה מרכזית"}</div>
...
console.log("TV updated with images");
